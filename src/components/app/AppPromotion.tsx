  ...
  return (
    <section className="app-promo">
      <div className="container app-promo__grid">
        <Image className="app-phone" src="/images/app/papp-app-phone.png" alt="" width={580} height={1112} />
        <div>
          ...
          <div className="store-badges" aria-label={locale === "da" ? "Download appen" : "Download the app"}>
            <a href={company.appStoreUrl} target="_blank" rel="noreferrer">
              <Image src="/images/app/appstore-badge.png" alt="Download on the App Store" width={193} height={66} />
            </a>
            <a href={company.googlePlayUrl} target="_blank" rel="noreferrer">
              <Image src="/images/app/googleplay-badge.png" alt="Get it on Google Play" width={193} height={65} />
            </a>
          </div>
